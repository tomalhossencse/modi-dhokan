...
const Hero = () => {
  return (
    <section className="relative overflow-hidden min-h-135 mb-10 rounded-3xl flex items-center ">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px lg:px-8 py-20 w-full">
        <div className="max-w-xl xl:pl-10">
          ...
          <div className="flex gap-3 flex-wrap">
            ...
            <Link
              to="/products"
              className="px-7 py-3 bg-white/10 text-white font-semibold rounded-full hover:bg-white/20 transition-all flex-center border border-white/20"
            >
