...
const ProductCard = ({ product }: Props) => {
  ...
  return (
    <div
      className="bg-white rounded-xl overflow-hidden shadow hover:shadow-md transition-all duration-300 group animate-fade-in cursor-pointer"
      ...
      <div className="p-3.5 text-zinc-700">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-1 truncate">
            ...
            <span className="text-xs font-app-text-light block">
              /{product.unit}
            </span>
